...
const resultsSeed = [
  ...
  {
    first: "Code: The Hidden Language of Computer Hardware and Software",
  ...
  {
    first: "The Everything Store: Jeff Bezos and the Age of Amazon",
    author: "Brad Stone",
    synopsis:
  ...
  {
    first: "Total Recall: My Unbelievably True Life Story",
  ...
  {
    first: "Elon Musk: Tesla, SpaceX, and the Quest for a Fantastic Future",
    author: "Ashlee Vance",
    synopsis:
  ...
  {
    first: "Astrophysics for People in a Hurry",
  ...
  {
    first: "Born a Crime: Stories from a South African Childhood",
    author: "Trevor Noah",
    synopsis:
